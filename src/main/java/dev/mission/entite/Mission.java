...
public class Mission {
	...
	public String toString() {
		return "Mission [id=" + id + ", dateDebut=" + dateDebut + ", dateFin=" + dateFin + ", libelle=" + libelle
				+ ", tauxJournalier=" + tauxJournalier + ", getId()=" + getId() + ", getDateDebut()=" + getDateDebut()
				+ ", getDateFin()=" + getDateFin() + ", getLibelle()=" + getLibelle() + ", getTauxJournalier()="
				+ getTauxJournalier() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
